...
class Ionic
{
    ...
    function markup()
    {
        ...
        if(isset($this->config['mod']['admob-free']['data']))
        {
            ...
            if(isset($banner['banner']['code']))
            {
                ...
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'banner: "'.$banner['banner']['code'].'",'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'interstitial: "'.$banner['interstitial']['code'].'",'.$this->enter;
                ...
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'admob.banner.config({'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'id: admobid.banner,'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'});'.$this->enter;
                if($banner['banner']['on-ready'] == true)
                {
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'admob.banner.prepare();'.$this->enter;
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$timeout(function(){'.$this->enter;
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'admob.banner.show();'.$this->enter;
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'},1000); '.$this->enter;
                }
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'// interstitial'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'admob.interstitial.config({'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'id: admobid.interstitial,'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'});'.$this->enter;
                if($banner['interstitial']['on-ready'] == true)
                {
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'admob.interstitial.prepare();'.$this->enter;
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$timeout(function(){'.$this->enter;
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'admob.interstitial.show();'.$this->enter;
                    $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'},1000); '.$this->enter;
                }
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'// rewardvideo'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'admob.rewardvideo.config({'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'id: admobid.rewardvideo,'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'});'.$this->enter;
        ...
        if(isset($this->config['mod']['admob']['data']))
        {
            ...
            if($banner['banner']['on-ready'] == true)
            {
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.''.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'// banner'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$run_banner = false;'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$timeout(function(){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'if($rootScope.liveStatus == "run"){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'$run_banner = true;'.$this->enter;
                ...
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'autoShow: true,'.$this->enter;
            ...
            if($banner['interstitial']['on-ready'] == true)
            {
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.''.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'// interstitial'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$run_interstitial = false;'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$timeout(function(){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'if($rootScope.liveStatus == "run"){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'$run_interstitial = true;'.$this->enter;
            ...
            if($banner['rewardvideo']['on-ready'] == true)
            {
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.''.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'// rewardvideo'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$run_rewardvideo = false;'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$timeout(function(){'.$this->enter;

                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'if($rootScope.liveStatus == "run"){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'$run_rewardvideo = true;'.$this->enter;
            ...
            $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.'$ionicPlatform.on("resume",function(){'.$this->enter;

            if($banner['banner']['on-ready'] == true)
            {
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'if($rootScope.liveStatus == "run" && $run_banner == false ){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'$run_banner = true;'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'AdMob.createBanner({'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'adId: admobid.banner,'.$this->enter;
                if($this->config['mod']['admob']['test'] == 'true')
            ...
            if($banner['interstitial']['on-ready'] == true)
            {
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'if($rootScope.liveStatus == "run" && $run_interstitial == false ){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'$run_interstitial = true;'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'AdMob.prepareInterstitial({'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'adId: admobid.interstitial,'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'autoShow: true,'.$this->enter;
            ...
            if($banner['rewardvideo']['on-ready'] == true)
            {
                ...
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'if($rootScope.liveStatus == "run" && $run_rewardvideo == false ){'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'$run_rewardvideo = true;'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'AdMob.prepareRewardVideoAd({'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'adId: admobid.rewardvideo,'.$this->enter;
                $this->app_js .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'autoShow: true,'.$this->enter;
        ...
        if(count($this->pageTabs) != 0)
        {
            ...
            foreach($this->pageTabs as $pageTabs)
            {
                ...
                if(($pageTabs['type'] == 'link') || ($pageTabs['type'] == 'iframe'))
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.addslashes($pageTabs['label']).'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ui-sref="'.$this->pagePrefix.'.'.$this->str2var($pageTabs['var']).$default_query.'" >'.$this->enter;
                ...
                {
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openWebView(\''.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'app-browser')
                {
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openAppBrowser(\''.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'ext-browser')
                {
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openURL(\''.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'ext-email')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openURL(\'mailto:'.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'ext-sms')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openURL(\'sms:'.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'ext-call')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openURL(\'tel:'.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'ext-playstore')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openURL(\'market://details?id='.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'ext-geo')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="openURL(\'geo:'.$pageTabs['option'].'\')" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                if($pageTabs['type'] == 'app-exit')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="exitApp()" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                ...
                if($pageTabs['type'] == 'app-home')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ui-sref="'.$this->pagePrefix.'.'.$this->config['app']['index'].'" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                ...
                if($pageTabs['type'] == 'html-link')
                {
                    ...
                    $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" href="'.$pageTabs['option'].'" >'.$this->enter;
                    $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                }
                ...
                if($this->config['cordova_plugin']['xsocialsharing']['enable'] == true)
                {
                    if($pageTabs['type'] == 'xsocialsharing-share-myapp')
                    {
                        ...
                        $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="socialShare(null, \''.$text_invite.'\',null,\''.$link_invite.'\')" >'.$this->enter;
                        $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                    }
                }
                ...
                if($this->config['cordova_plugin']['barcodescanner']['enable'] == true)
                {
                    if($pageTabs['type'] == 'barcodescanner-alert')
                    {
                        ...
                        $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="barcodeScanner(\'alert\')" >'.$this->enter;
                        $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                    }
                    if($pageTabs['type'] == 'barcodescanner-link-internal')
                    {
                        ...
                        $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="barcodeScanner(\'inlink\')" >'.$this->enter;
                        $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                    }
                    if($pageTabs['type'] == 'barcodescanner-link-external')
                    {
                        ...
                        $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="barcodeScanner(\'outlink\')" >'.$this->enter;
                        $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                    }
                    if($pageTabs['type'] == 'barcodescanner-appbrowser')
                    {
                        ...
                        $ionic .= $this->tab.'<ion-tab class="menu-'.$pageTabs['var'].'" title="{{ \''.$pageTabs['label'].'\' | translate }}" icon-off="'.$pageTabs['icon-alt'].'" icon-on="'.$pageTabs['icon'].'" ng-click="barcodeScanner(\'appbrowser\')" >'.$this->enter;
                        $ionic .= $this->tab.'</ion-tab>'.$this->enter;
                    }
                }
            }
        ...
        if(count($this->pageSideMenus) != 0)
        {
            ...
            foreach($this->pageSideMenus as $pageSideMenus)
            {
                ...
                if(($pageSideMenus['type'] == 'link') || ($pageSideMenus['type'] == 'iframe'))
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ui-sref="'.$this->pagePrefix.'.'.$this->str2var($pageSideMenus['var']).$default_query.'">'.$this->enter;
                ...
                {
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item class="item item-divider text-'.$direction.'" >'.$this->enter;
                ...
                {
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openWebView(\''.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'app-browser')
                {
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openAppBrowser(\''.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'ext-browser')
                {
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openURL(\''.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'ext-email')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openURL(\'mailto:'.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'ext-sms')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openURL(\'sms:'.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'ext-call')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openURL(\'tel:'.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'ext-playstore')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openURL(\'market://details?id='.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'ext-geo')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="openURL(\'geo:'.$pageSideMenus['option'].'\')">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'app-exit')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="exitApp()">'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'app-home')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close=""  ui-sref="'.$this->pagePrefix.'.'.$this->config['app']['index'].'" >'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                if($pageSideMenus['type'] == 'html-link')
                {
                    ...
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close=""  href="'.$pageSideMenus['option'].'" >'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                    $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                }
                ...
                if($this->config['cordova_plugin']['xsocialsharing']['enable'] == true)
                {
                    if($pageSideMenus['type'] == 'xsocialsharing-share-myapp')
                    {
                        ...
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="socialShare(null,\''.$text_invite.'\',null,\''.$link_invite.'\')" >'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                    }
                }
                ...
                if($this->config['cordova_plugin']['barcodescanner']['enable'] == true)
                {
                    if($pageSideMenus['type'] == 'barcodescanner-alert')
                    {
                        ...
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="barcodeScanner(\'alert\')" >'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                    }
                    if($pageSideMenus['type'] == 'barcodescanner-link-internal')
                    {
                        ...
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="barcodeScanner(\'inlink\')" >'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                    }
                    if($pageSideMenus['type'] == 'barcodescanner-link-external')
                    {
                        ...
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="barcodeScanner(\'outlink\')">'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                    }
                    if($pageSideMenus['type'] == 'barcodescanner-appbrowser')
                    {
                        ...
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'<ion-item '.$this->soundtouch.' class="menu-'.$this->str2var($pageSideMenus['var']).' item-sidebar item item-icon-'.$direction.' text-'.$direction.' dark-ink" nav-clear="" menu-close="" ng-click="barcodeScanner(\'appbrowser\')">'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.$this->tab.'<i class="icon '.$pageSideMenus['icon'].'"></i> {{ "'.$pageSideMenus['label'].'" | translate }}'.$this->enter;
                        $ionic .= $this->tab.$this->tab.$this->tab.$this->tab.'</ion-item>'.$this->enter;
                    }
                }
    ...
    function add_controllers($page,$code = null)
    {
        ...
        if($this->str2var($page['prefix']) == 'index')
        {
            ...
            {
                $this->controllers_js .= $this->enter;
                $this->controllers_js .= $this->tab.'// TO'.'DO: controllers_js --|-- $rootScope.socialShare'.$this->enter;
            ...
            {
                $this->controllers_js .= $this->enter;
                $this->controllers_js .= $this->tab.'// TO'.'DO: controllers_js --|-- $rootScope.barcodeScanner'.$this->enter;
