...
// CMS INTEGRATION
if (isset($_GET['cms']) && (basename($_GET['cms']) == $_GET['cms']) && is_file("integration/{$_GET['cms']}.php"))
 ...
 * $session = new SessionSaveHandler();
 * $session->open(ini_get('session.save_handler'),'JZ-CMS');
...
if ($_SESSION["JSM_DEMO"] == false)
{
    if (isset($_SESSION['PROJECT']['app']))
    {
        $_SESSION['KCFINDER'] = array(
            'disabled' => false,
            'uploadURL' => '../../../output/' . $_SESSION['PROJECT']['app']['prefix'] . '/www/data/',
            'uploadDir' => '',
            'thumbsDir' => "../../.thumbs/",
            'thumbWidth' => 80,
            'thumbHeight' => 80,
